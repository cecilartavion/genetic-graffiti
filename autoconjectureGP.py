...
Tonight I only care about hypercubes.
'''

hypercubes = [nx.hypercube_graph(n) for n in range(3,12)]
...
X_train = [[nx.graph_clique_number(hc),nx.diameter(hc)]for hc in hypercubes]
Y_train = [nx.radius(hc) for hc in hypercubes]
